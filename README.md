...
are CCP implementation 1.3/API 1.0, BDOS implementation 1.5/API 1.2,
BIOS implementation 1.5/API 1.2, and CPX/RSX implementation 1.2/API 1.0.
...
bindings the single operational disk authority. FDB identity records provenance,
while media observations and derived filesystem state remain separate.
