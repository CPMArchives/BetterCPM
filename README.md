...
[`Engineering Specification 91`](docs/engineering/91%20BIOSTEST%20Returning%20Baseline.md) closes the guarded BIOS-trace investigation, records all 18 executable required passes, and separates the 17 remaining manual/provider/profile procedures from core BIOS implementation.
