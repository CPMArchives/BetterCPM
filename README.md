...
[`Engineering Specification 91`](docs/engineering/91%20BIOSTEST%20Returning%20Baseline.md) closes the guarded BIOS-trace investigation, records 23 physical required passes including write-protect and console control, and separates the 12 remaining manual/provider/profile procedures from core BIOS implementation.
