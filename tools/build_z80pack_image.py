...
'''+reload[b:]
 ...
 for name in ('R3PLAN.RSX','R3SLOTS.RSX','R3SNAP.RSX','R3CARR.RSX','R3META.RSX','R3COORD.RSX','R3MOVE.RSX','R3COMIT.RSX'):files.append((name,(ROOT/'build/system'/name).read_bytes()))
