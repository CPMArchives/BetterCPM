...
EXPECTED_LINES = (
    ...
    b"A: WARM     COM : CONFIG   COM : DUP      COM : SYSGEN   COM",
    b"A: STAT     COM : SUBMIT   COM : XSUB     COM : DISK     FDF",
    b"A: FDF      RSX : RCP      CPX : HELLO    CPX : HELLO    RSX",
    b"A: ECHO     RSX : BATCHIO  RSX : BDOSPRB  COM : COMINFO  COM",
    b"A: DISKEDIT COM : DISKINFO COM : DPBCHK   COM : FSCK     COM",
    b"A: SYSINFO  COM : TOOLS    DOC : SYSGEN   DAT",
    b"",
    b"A0>HELLO WORLD",
