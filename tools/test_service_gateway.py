#!/usr/bin/env python3
"""Exercise Function 182 through the fixed resident extension bridge."""
...
def main() -> None:
    ...
    require(empty.a == 1 and empty.hl == 0 and empty.de == REQUEST,
            "empty Function 182 gateway result is incorrect")
    require(empty.mem[REQUEST + 12:REQUEST + 19] == bytes(7) and
            empty.mem[REQUEST + 19] == 1,
            "empty Function 182 gateway did not clear outputs")
    ...
    require(live.a == 0 and live.hl == base + 0x20 and live.de == REQUEST,
            "resident Function 182 gateway did not return resolver results")
    print("Function 182 fixed gateway handles empty and active registries")
