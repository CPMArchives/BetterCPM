...
extension. The current image has implemented all except `USER`; adding it is
the remaining command-migration step. BASIC is reconstructed on cold and warm boot. The CCP still contains its
